...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $tipo = $_POST['tipo']; // Recebe diretamente do formulário
    ...
    if (empty($erros)) {
        $dados = [
            ...
            'tipo' => $tipo // Usa o valor selecionado no formulário
        ];
    ...
    <div class="box">
        ...
        <form action="cadastro_new_V2.php" method="POST" id="formCadastro" novalidate>
            ...
            <div class="inputBox">
                ...
                <option value="usuario" <?php echo (isset($_POST['tipo']) && $_POST['tipo'] === 'usuario') ? 'selected' : ''; ?>>Usuário Normal</option>
